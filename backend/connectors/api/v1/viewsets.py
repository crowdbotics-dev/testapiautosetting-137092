...
class Testconnectors137092ViewSet(BaseConnectorViewSet):
    PASSWORD = settings.CONNECTOR_TESTCONNECTORS137092_PASSWORD
    USERNAME = settings.CONNECTOR_TESTCONNECTORS137092_USERNAME
    BASE_URL = "https://devstringx.com"
    AUTH_TYPE = "basic"
    IDENTIFIER = "CONNECTOR_TESTCONNECTORS137092"
